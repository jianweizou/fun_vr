...
#define WIFI_MESH_DHCP_CLIENT               0x4
#define WIFI_MESH_DHCP_SERVER               0x8
#define WIFI_MESH_STATIC_IP                 0x10
...
/**
 * Return WICED_TRUE if the STA interface has an active 802.11 association
 *
