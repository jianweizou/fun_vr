...
#if defined(CONFIG_MODULE_USBD_MSC_DEBUG)
#define USBD_MSC_PRINT(fmt, args...)            printf("[USBD_MSC]"fmt"\r", ##args)
#else
#define USBD_MSC_PRINT(...)                     ((void) 0)
#endif

#define USBD_MSC_PRINT_ERR(fmt, args...)        printf("[USBD_MSC](error)"fmt"\r", ##args)

/*==========================================*/
/*				user define 				*/
/*==========================================*/
#define MSC_VENDOR_ID                           0x0C45	/* Sonix Technology Co. */
#define MSC_PRODUCT_ID                          0x6480	/* SN98660 MSC */
#define MSC_DEVICE_BCD                          0x0100	/* 1.00 */
...
// Variable
static char mass_storage_vendor_label[]         = "Sonix Technology Co., Ltd.";
static char mass_storage_product_label[]        = "USB2.0 Mass Storage";
static char mass_storage_config_label[]         = "Sonix Storage";
static char mass_storage_serial_num_label[]     = "100000000000";

static char msc_vendor_name[16]                 = "SONiX  ";
static char msc_product_name[8]                 = "USB MSC";
static char msc_release[4]                      = "0.0";
