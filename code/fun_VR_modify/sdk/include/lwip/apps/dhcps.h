...
#define DHCPS_PRINT(fmt, args...) printf("[DHCPS]%s : "fmt, __func__,  ##args)
#define DHCPS_PRINT_QUEUE(fmt, args...) printf("[DHCPS]%s : "fmt, __func__,##args)
...
#define DHCPS_DNS_ADDR		"129.219.13.81"
#endif
...
uint8_t * get_mac_by_ip(uint32_t);

#if CONFIG_DHCP_OPTION_DNS_SERVER
int dhcps_set_dns(char *);
#endif
