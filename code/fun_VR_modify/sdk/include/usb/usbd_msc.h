...
#if(USBD_MSC_DEBUG == 1)
    #define USBD_MSC_PRINT(fmt, args...)            printf("[USBD_MSC]"fmt, ##args)
#else
...
void usbd_media_maxblock_update(uint32_t block);/*Add By Howard*/
void usbd_set_max_lun(uint8_t lun);/*Add By Howard*/
#endif
