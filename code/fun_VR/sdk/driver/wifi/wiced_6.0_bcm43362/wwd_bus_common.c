...
#include "internal/wwd_internal.h"   /* TODO: fix include dependency */
...
extern const unsigned char wifi_bcm43362_firmware_image[];
extern const unsigned long wifi_bcm43362_firmware_image_size;// = (unsigned long) sizeof(wifi_firmware_image);
...
#else
	 wifi_firmware_image.location = RESOURCE_IN_MEMORY;
	 wifi_firmware_image.size = wifi_bcm43362_firmware_image_size;
	 wifi_firmware_image.val.mem.data = (const char *)&wifi_bcm43362_firmware_image[0];
