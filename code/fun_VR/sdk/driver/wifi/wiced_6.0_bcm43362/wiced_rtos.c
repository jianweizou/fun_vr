...
wiced_result_t wiced_rtos_create_thread( wiced_thread_t* thread, uint8_t priority, const char* name, wiced_thread_function_t function, uint32_t stack_size, void* arg )
{
    ...
    return (wiced_result_t) host_rtos_create_thread_with_arg( WICED_GET_THREAD_HANDLE( thread ), function, name, NULL, stack_size, WICED_PRIORITY_TO_NATIVE_PRIORITY( priority ), (uint32_t) arg );
}
...
wiced_result_t wiced_rtos_create_thread_with_stack( wiced_thread_t* thread, uint8_t priority, const char* name, wiced_thread_function_t function, void* stack, uint32_t stack_size, void* arg )
{
    ...
    return (wiced_result_t) host_rtos_create_thread_with_arg( WICED_GET_THREAD_HANDLE( thread ), function, name, stack, stack_size, WICED_PRIORITY_TO_NATIVE_PRIORITY( priority ), (uint32_t)arg );
}
...
wiced_result_t wiced_rtos_delete_thread(wiced_thread_t* thread)
{
    ...
    result = (wiced_result_t)host_rtos_finish_thread( WICED_GET_THREAD_HANDLE( thread ) );
    ...
    return (wiced_result_t)host_rtos_delete_terminated_thread( WICED_GET_THREAD_HANDLE( thread ) );
}
...
wiced_result_t wiced_rtos_init_queue( wiced_queue_t* queue, const char* name, uint32_t message_size, uint32_t number_of_messages )
{
    ...
    return(wiced_result_t)host_rtos_init_queue( WICED_GET_QUEUE_HANDLE( queue ), NULL, number_of_messages * message_size, message_size );
}
...
{
    return (wiced_result_t)host_rtos_deinit_queue( WICED_GET_QUEUE_HANDLE( queue ) );
}
