...
#if defined(CONFIG_MODULE_USBD_UVC_DEBUG)
#define USBD_UVC_PRINT(fmt, args...) printf("\r[USBD_UVC]"fmt, ##args)
#else
#define USBD_UVC_PRINT(...)		((void) 0)
#endif

#define USBD_UVC_IMGAE_HEADER   0


#define UVC_DEVICE_INFOMATION_UNCOMPRESSED_FORMAT_ENABLE        1
#define UVC_DEVICE_INFOMATION_UNCOMPRESSED_FRAME_COUNT          2
#define UVC_DEVICE_INFOMATION_UNCOMPRESSED_FPS_COUNT            5

#define UVC_DEVICE_INFOMATION_MJPEG_FORMAT_ENABLE               1
#define UVC_DEVICE_INFOMATION_MJPEG_FRAME_COUNT                 3
#define UVC_DEVICE_INFOMATION_MJPEG_FPS_COUNT                   5

#define UVC_DEVICE_INFOMATION_FRAMEBASE_FORMAT_ENABLE           1
#define UVC_DEVICE_INFOMATION_FRAMEBASE_FRAME_COUNT             3
#define UVC_DEVICE_INFOMATION_FRAMEBASE_FPS_COUNT               5
...
//#define UVC_MAX_PAYLOAD_SIZE                            (((1920*1080*2)+12))
#if defined (CONFIG_SNX_ISO_ACCELERATOR) && !defined (CONFIG_MODULE_USB_DEVICE_DUMMY_PATTERN)
#define UVC_MAX_PAYLOAD_SIZE                            CONFIG_MODULE_USBH_MJPEG_SIZE*1024
#else
#define UVC_MAX_PAYLOAD_SIZE                            300*1024
#endif
...
//void usbd_uvc_drv_send_image(uint32_t *img_buf, unsigned int img_len);
