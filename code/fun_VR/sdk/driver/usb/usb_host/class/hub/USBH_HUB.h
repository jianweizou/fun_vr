...
#include "stdio.h"	
	...
	#define HUB_DBG(args...)
#endif
	#define HUB_INFO(format, args...) printf("\r\nHUB_INFO:"format, ##args)
#endif
...
extern QueueHandle_t		usbh_queue_hub_drv;

extern void hub_task(void * pvParameters);
#endif
#if defined (CONFIG_USBH_CMSIS_OS)
extern osMessageQId		usbh_queue_hub_drv;

extern void hub_task(void const *pvParameters);
#endif

extern void hub_task_init(uint8_t device_id);
extern void hub_task_uninit(uint8_t device_id);
extern void usbh_hub_enum(USBH_Device_Structure *DEV, uint8_t hub_id);
