...
#define	EHCI_REG_BASE_ADDRESS			0x90800000		/**< IP Physical Address */
	...
	#define	EHCI_REG_BASE_ADDRESS_2		EHCI_2_BASE 		/**< IP Physical Address */
#endif // End of if defined( CONFIG_DUAL_HOST )	
#else
	#define	EHCI_REG_BASE_ADDRESS		0x94200000		/**< IP Physical Address */
#if defined( CONFIG_DUAL_HOST )
	#define	EHCI_REG_BASE_ADDRESS_2		0x94300000		/**< IP Physical Address */
#endif
#endif
#endif
	...
	//#include "snc7320.h"
	#define	EHCI_REG_BASE_ADDRESS		SN_USB_HOST0_BASE 
#if defined( CONFIG_DUAL_HOST )	
	#define	EHCI_REG_BASE_ADDRESS_2		SN_USB_HOST1_BASE 
#endif // End of if defined( CONFIG_DUAL_HOST )	
#endif
...
#else
#define	MJPEGFrameSize			250*3*1024
#define	H264FrameSize			200*3*1024
#endif
...
#define	Max_STD_ISO_FrameSize			1000*1024
...
// EHCI Structure Size
#if defined (CONFIG_PLATFORM_SN7300)
#define EHCI_STRUCT_SIZE 			10*1024
#else
#if defined (CONFIG_MODULE_USB_UVC_SRAM)
#define EHCI_STRUCT_SIZE 			16*1024
#else
#define EHCI_STRUCT_SIZE 			32*1024
#endif
#endif
...
#if defined (CONFIG_MODULE_USB_UVC_SRAM)
// EHCI	QH/QTD Manage 
#define	EHCI_QH_MAX				8
#define	EHCI_QTD_MAX				64
#define	EHCI_ITD_MAX				128
#define	EHCI_SXITD_MAX				2
#else
// EHCI	QH/QTD Manage 
...
#if defined( CONFIG_PLATFORM_SN9866X ) || defined( CONFIG_PLATFORM_SN7300 ) || defined( CONFIG_PLATFORM_XILINX_ZYNQ_7000 )
typedef	struct{
...
typedef	struct{
	...
	uint32_t PERIODIC_STS		: 1;	// [14]		[0x00]
	uint32_t ASYNC_STS		: 1;	// [15]		[0x00]
	uint32_t RESERVED1		: 14;	// [29:16]	[0x00]
	uint32_t BUF_FULL		: 1; 	// [30]		[0x00]
...
typedef	struct{
	...
	uint32_t PERIODIC_STS		: 1;	// [14]		[0x00]
	uint32_t ASYNC_STS		: 1;	// [15]		[0x00]
	uint32_t OUT_EOF_ABORT		: 1;	// [16]		[0x00]	
	uint32_t RESERVED29_15		: 13;	// [29:15]	[0x00]
	uint32_t BUF_FULL		: 1; 	// [30]		[0x00]
	uint32_t SOF_INT		: 1;	// [31]		[0x00]
}EHCI_USBSTS;
#endif
...
typedef	struct{
	...
	uint32_t SYS_ERR_INT_EN		: 1;	// [04]		[0x00]
	uint32_t ASYNC_ADVANCE_INT_EN   : 1;	// [05]		[0x00]
	uint32_t RESERVED0		: 24;   // [29:06]	[0x00]
	uint32_t BUF_FULL_INT_EN :1; // [30]	[0x00]
...
typedef	struct{
	...
	uint32_t SYS_ERR_INT_EN		: 1;	// [04]		[0x00]
	uint32_t ASYNC_ADVANCE_INT_EN   : 1;	// [05]		[0x00]
	uint32_t REGW_TO_INT_EN   	: 1;	// [06]		[0x00]	
	uint32_t RESERVED15_7		: 9;    // [15:07]	[0x00]
	uint32_t OUT_EOF_ABORT_INT_EN	: 1;    // [16]		[0x00]	
	uint32_t RESERVED29_17		:13;    // [29:17]	[0x00]	
	uint32_t BUF_FULL_INT_EN 	: 1; 	// [30]		[0x00]
	uint32_t SOF_INT_EN		: 1;	// [31]		[0x00]	
}EHCI_USBINTR;
#endif 
...
typedef	struct{
	...
	uint32_t TX_BABBLE_EN		: 1;
	uint32_t RUN_CLR_EN		: 1;	
	uint32_t RESERVED15		: 1;	
	uint32_t PEN_CLR_EN		: 1;	
	uint32_t RESERVED17		: 1;	
	uint32_t DENOISE_EN		: 1;
	uint32_t UFC_EOF_TO_EN		: 1;	
	uint32_t SX_ACT_CLR_EN		: 1;	
	uint32_t SX_FB_ACT_CLR_EN	: 1;	
	uint32_t RESERVED23_22		: 2;	
	uint32_t AHBM_UNSP_R512_EN	: 1;	
	uint32_t RESERVED31_25		: 7;	// [31:01]	[0x00]

}EHCI_EC_CTL;
#endif // end if defined( CONFIG_PLATFORM_SN7320 )
...
typedef	struct{
	...
	uint32_t HK_DEL_CNT		: 5;	
	uint32_t TX_BABBLE_EN		: 1;	
	uint32_t RESERVED14		: 25;	// [31:01]	[0x00]

}EHCI_EC_CTL;
#endif // end if defined( CONFIG_PLATFORM_ST53510 )

#if defined( CONFIG_PLATFORM_SN9866X ) || defined( CONFIG_PLATFORM_SN7300 )
typedef	struct{
...
#endif // end if defined( CONFIG_PLATFORM_SN9866X ) || defined( CONFIG_PLATFORM_SN7300 )
...
typedef	struct{
	...
	uint32_t REGW_TO		: 1;
	uint32_t RESERVED7_5		: 3;
	uint32_t FRINDEX_ERR		: 14;
	uint32_t TIMEOUT		: 1;
	uint32_t RXERR			: 1;
	uint32_t PID_ERR		: 1;
	uint32_t UVC_H_ERR		: 1;
	uint32_t CRC16_ERR		: 1;
	uint32_t BABBLE			: 1;
	uint32_t FRAME_BABBLE		: 1;
	uint32_t RX_NOISE		: 1;
	uint32_t UFC_EOF_TO		: 1;		
	uint32_t RESERVED31		: 1;	// [31]		[0x00]
}EHCI_EC_STS;
#endif // end if defined( CONFIG_PLATFORM_SN7320 )
...
typedef	struct{
	...
	uint32_t PO_FSDIS_CHG		: 1;
	uint32_t REGW_TO		: 1;	
	uint32_t RESERVED5		: 27;	// [31:04]	[0x00]
...
typedef	struct{
	...
	uint32_t	LEV_INT_EN	: 1;		
	uint32_t	BYP_INT_TH_EN	: 1;
...
typedef struct	_iTD_BufferPointer {
 ...
 typedef	struct _SNXiTD {
  ...
  typedef	struct _SNXiTD {
	...
	uint32_t		bBabble_Det:1;
	uint32_t		bACTIVE:1;
	uint32_t		bErrDiscard_EN:1;	
	uint32_t		bReserve_3:2;
	uint32_t		bRING_THRESHOLD:20;	
	...
	uint32_t		bFID_Count:2;
	uint32_t		bFID:1;
	uint32_t		bErr_DISCARD:1;	
	uint32_t		bReserve_4:26;
...
typedef	struct
{
	...
	uint32_t		*RING_BUFF_PTR_W;
	uint32_t		*RING_BUFF_PTR_X;
	uint32_t		*RING_BUFF_PTR_Y;
...
typedef	struct
{
	uint32_t		SIZE;
	uint32_t		*pBUFF;
	uint32_t		*BULK_PING_PTR;
	uint32_t		*BULK_PONG_PTR;
}EHCI_BK_PACKET_XFR_Struct;
...
extern void USB_HOST0_IRQHandler(void);
#endif
...
#if defined( CONFIG_DUAL_HOST )	
// EHCI	Global declare 
extern volatile EHCI_PERIODIC_TABLE_Struct 	PERIODIC_TABLE_2;
extern volatile SONIX_EHCI_STRUCTURE 		*EHCI2;
extern volatile EHCI_QH_STRUCTURE 		*pHEAD_QH_2;

extern void ehci_hcd_init_2(void);
extern void ehci_hcd_uninit_2(void);
extern void ehci_struct_init_2(uint32_t *ptr);
extern void ehci_struct_uninit_2(void);
#if defined( CONFIG_SN_GCC_SDK )
extern void ehci_isr_2(int irq);
#endif
#if defined( CONFIG_SN_KEIL_SDK ) && defined ( CONFIG_PLATFORM_ST53510 )
extern void ehci_isr_2(void);
#endif
#if defined( CONFIG_SN_KEIL_SDK ) && defined ( CONFIG_PLATFORM_SN7300 )
extern void USBHOST_IRQHandler_2(void);
#endif
#if defined( CONFIG_SN_KEIL_SDK ) && defined ( CONFIG_PLATFORM_SN7320 )
extern void USB_HOST1_IRQHandler(void);
#endif
#if defined( CONFIG_XILINX_SDK ) && defined ( CONFIG_PLATFORM_XILINX_ZYNQ_7000 )
extern void ehci_isr_2(void *HandlerRef);
#endif
extern void ehci_remove_periodic_table_2(void *ptr);
#endif // End of if defined( CONFIG_DUAL_HOST )	

extern void ehci_xfr_chk_isr(void);
extern uint8_t ehci_chk_xfr_result(EHCI_ENDP_STRUCT *EP);
extern uint32_t	ehci_get_structure(EHCI_ALLOC_REQUEST_Struct *AllocReq,uint8_t host);
extern void ehci_release_structure(uint32_t  StructType,uint32_t PTR,uint8_t host);
extern void ehci_adding_qh_tail(EHCI_QH_STRUCTURE* ADD_QH,uint8_t host);
extern void removing_qh(EHCI_QH_STRUCTURE* RMV_QH,uint8_t host);
...
extern EHCI_ENDP_STRUCT	ehci_cx_allocate(EHCI_ALLOC_REQUEST_Struct *AllocReq,uint8_t host);
extern EHCI_ENDP_STRUCT	ehci_bk_allocate(EHCI_ALLOC_REQUEST_Struct *AllocReq,uint8_t host);
extern EHCI_ENDP_STRUCT	ehci_int_allocate(EHCI_ALLOC_REQUEST_Struct *AllocReq,uint8_t host);
extern EHCI_ENDP_STRUCT	ehci_iso_allocate(EHCI_ALLOC_REQUEST_Struct *AllocReq,uint8_t host);
